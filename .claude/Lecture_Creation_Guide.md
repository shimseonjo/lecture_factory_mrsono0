...
| 검증 항목 수 | 36개 (6영역) | ~38개 (5영역: G+P+T+C+N) | ~15개 (S+일관성) |
...
| N: 교안 실행 품질 | N-1~N-8 | 8 | **발화문 자연성+내용 충실도(N-1)**, 활동 3요소, 집계 정합, 강사 가이드, 표기법, **brainstorm 소재 활용도(N-8)** |
