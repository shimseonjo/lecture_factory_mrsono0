...
| Phase | 단계 | 에이전트 | 핵심 작업 |
|-------|------|---------|----------|
| 1 | 입력 수집 | input-agent | 필수 6개(주제, 학습자, 목표, 형태, 시간, 키워드) + 선택 9개 → input_data.json |
...
**교안 (`/lecture-script`)** — 6영역 48항목, 가중치 미적용, 블록별 검토(Phase 7) + 통합 검토(Phase 8) 2단계:
...
| C: 콘텐츠 정확성 | 9 | Anti-Hallucination, CLO/SLO·차시·발문·활동 입력 원본 대조 | Phase 7 (블록별) |
