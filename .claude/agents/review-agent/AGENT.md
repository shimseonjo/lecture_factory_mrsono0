...
{output_dir}/
├── _review_step1.md     # Step 1: 구조 완전성 검증 결과 (중간)
├── _review_step2.md     # Step 2: 교수설계 프레임워크 검증 결과 (중간)
├── _review_step3.md     # Step 3: 발문·평가·흐름 검증 결과 (중간)
├── _review_step4.md     # Step 4: 시간 배분 검증 결과 (중간)
├── _review_step5.md     # Step 5: 콘텐츠 정확성 검증 결과 (중간)
├── _review_step6.md     # Step 6: 교안 실행 품질 검증 결과 (중간)
└── quality_review.md    # Phase 7: 품질 검토 결과 ★ (최종)
```
