...
| S-6 | 서브섹션 완전성 | §1(1-1~1-3), §2(2-1~2-2), §3(3-1~3-2), §5(5-1~5-3), §6(6-1~6-4), §7(7-1~7-3), §8(8-1~8-3), §9(9-1~9-4) 총 22개 서브섹션 모두 존재 | Major (누락 서브섹션당) |
...
- 검증 항목 수: 32개 (S:6 + L:5 + A:5 + F:4 + T:7 + C:9)
