...
Step 0: 입력 로드
  ...
  │
  └── Step 5: 판정 + 산출물 작성 → quality_review.md
```
...
```
{output_dir}/
└── quality_review.md    # Phase 7: 품질 검토 결과 ★
```
...
| # | 검증 항목 | 기준 | 위반 유형 |
|---|----------|------|----------|
| T-1 | 일일 시간 합계 | 각 Day의 교시 수 × session_minutes ≤ hours_per_day × 60 | Major (초과 10%+), Minor (초과 5% 미만) |
...
| 구조 완전성 | - | {N} | {N} | {N} | {N} |
| 학습목표 명확성 | 25% | {N} | {N} | {N} | {N} |
| 목표-활동-평가 정렬 | 25% | {N} | {N} | {N} | {N} |
| 콘텐츠 구조/흐름 | 15% | {N} | {N} | {N} | {N} |
| 시간 배분 현실성 | 15% | {N} | {N} | {N} | {N} |
| 콘텐츠 정확성 | 20% | {N} | {N} | {N} | {N} |
| **합계** | **100%** | {N} | {N} | {N} | {N} |
...
| # | 검증 ID | 영역 | 위반 내용 | 해당 섹션 | 수정 가이드 |
|---|---------|------|----------|----------|-----------|
| 1 | {L-1 등} | {영역} | {구체적 위반 내용} | §{N} | {수정 방법} |
...
| # | 검증 ID | 영역 | 위반 내용 | 해당 섹션 | 수정 권고 |
|---|---------|------|----------|----------|----------|
| 1 | {S-2 등} | {영역} | {구체적 위반 내용} | §{N} | {권고 사항} |
...
**권고 수정 사항**: Minor 위반 목록 참조. 부분 수정 후 재검토 권장.

{REVISION REQUIRED인 경우}:
**필수 수정 사항**: Major 위반 목록의 수정 가이드를 따라 해당 섹션을 재작성해야 합니다.
```
