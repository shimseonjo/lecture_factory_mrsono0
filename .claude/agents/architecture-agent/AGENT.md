...
5. content_type 판별
   각 차시에 content_type을 배정한다. 이 값은 교안 Phase 5~7에서 context7 호출 필수 여부와 코드 밀도 기준으로 사용된다.

   | content_type | 정의 | 판별 조건 |
   |-------------|------|----------|
   | hands-on | 코드 작성·도구 실습이 주 활동 | (활동 유형 ∈ {안내 실습, 독립 실습, 탐색 실습, 강의/시연, 시연}) AND (keywords에 기술 라이브러리 1개 이상) |
   | concept | 개념 설명·비유·메타포 중심 | (활동 유형 ∈ {강의, 강의/토론, 강의/비교, Q&A, 비교 체험}) OR (실습 유형이지만 keywords에 기술 라이브러리 없음) |
   | activity | 발표·토론·복습·평가·정리 중심 | (활동 유형 ∈ {발표, 토론, 토론/정리, 정리}) OR (SLO == "—") |

   판별 순서:
   - SLO == "—" or 활동 유형 ∈ [발표, 토론, 토론/정리, 정리] → activity
   - 활동 유형 ∈ [안내 실습, 독립 실습, 탐색 실습, 강의/시연, 시연] AND keywords에 기술 라이브러리 → hands-on
   - 활동 유형 ∈ [안내 실습, 독립 실습, 탐색 실습, 강의/시연, 시연] AND keywords에 기술 라이브러리 없음 → concept
   - 그 외 (강의, 강의/토론, Q&A 등) → concept (기본값)

   검증: content_type == hands-on 차시가 0개인데 keywords에 기술 라이브러리가 존재하면 경고 출력.
```
...
| 교시 | 시간 | 하위 주제 | 우선순위 | 활동 유형 | content_type | Bloom's | SLO |
|------|------|----------|---------|----------|-------------|---------|-----|
| 1 | {시작~종료} | {주제} | Must | 강의+실습 | hands-on | 기억 | SLO1-1 |
| 2 | {시작~종료} | {주제} | Must | 안내실습 | hands-on | 적용 | SLO1-2 |
| ... | ... | ... | ... | ... | ... | ... | ... |
